...
/**
 * One external uptime check of a site's public URL. Two consecutive
 * failures open an incident (a single network blip is not an outage);
 * one healthy check closes it.
 */
class CheckSiteUptime
{
